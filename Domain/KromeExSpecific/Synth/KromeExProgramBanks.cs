...
namespace PcgTools.Model.KromeExSpecific.Synth
{
    ...
    public class KromeExProgramBanks : MProgramBanks
    {
        ...
        protected override void CreateBanks()
        {
            ...
            Add(new KromeExProgramBank(this, BankType.EType.User, "U-A", 6, ProgramBank.SynthesisType.Edsx,
                "Id U-A")); //  6
            Add(new KromeExProgramBank(this, BankType.EType.User, "U-B", 7, ProgramBank.SynthesisType.Edsx,
                "Id U-B")); //  7
            Add(new KromeExProgramBank(this, BankType.EType.User, "U-C", 8, ProgramBank.SynthesisType.Edsx,
                "Id U-C")); //  8
            Add(new KromeExProgramBank(this, BankType.EType.User, "U-D", 9, ProgramBank.SynthesisType.Edsx,
                "Id U-D")); //  9
            Add(new KromeExProgramBank(this, BankType.EType.User, "U-E", 10, ProgramBank.SynthesisType.Edsx,
                "Id U-E")); //  10
            Add(new KromeExProgramBank(this, BankType.EType.User, "U-F", 11, ProgramBank.SynthesisType.Edsx,
                "Id U-F")); //  11
