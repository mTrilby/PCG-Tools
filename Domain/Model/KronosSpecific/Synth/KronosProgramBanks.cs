...
namespace Domain.Model.KronosSpecific.Synth
{
    ...
    public class KronosProgramBanks : KronosOasysProgramBanks
    {
        ...
        protected override void CreateBanks()
        {
            ...
            Add(new KronosProgramBank(
                this, BankTypeEType.Int, "I-C", 2, ProgramBankSynthesisType.Unknown, "HD-1"));                                            //  2
            ...
            Add(new KronosProgramBank(
                this, BankTypeEType.User, "U-G", 23, ProgramBankSynthesisType.Unknown, "Initialized HD-1 Programs"));                     // 12 ; if changed -> change KronosTimbre


            Add(new KronosProgramBank(
                this, BankTypeEType.UserExtended, "U-AA", 24, ProgramBankSynthesisType.Unknown, string.Empty));                           // 13
            
            Add(new KronosProgramBank(
                this, BankTypeEType.UserExtended, "U-BB", 25, ProgramBankSynthesisType.Unknown, string.Empty));                           // 14
            
            Add(new KronosProgramBank(
                this, BankTypeEType.UserExtended, "U-CC", 26, ProgramBankSynthesisType.Unknown, string.Empty));                           // 15
            
            Add(new KronosProgramBank(
                this, BankTypeEType.UserExtended, "U-DD", 27, ProgramBankSynthesisType.Unknown, string.Empty));                           // 16
            
            Add(new KronosProgramBank(
                this, BankTypeEType.UserExtended, "U-EE", 28, ProgramBankSynthesisType.Unknown, string.Empty));                           // 17 
            
            Add(new KronosProgramBank(
                this, BankTypeEType.UserExtended, "U-FF", 29, ProgramBankSynthesisType.Unknown, string.Empty));                           // 18
            
            Add(new KronosProgramBank(
                this, BankTypeEType.UserExtended, "U-GG", 30, ProgramBankSynthesisType.Unknown, string.Empty));                           // 19
            ...
            Add(new KronosGmProgramBank(
                this, BankTypeEType.Gm, "GM", 6, ProgramBankSynthesisType.Hd1, "GM2 Main programs"));          // [84]
        }
