...
namespace Domain.Model.M3Specific.Pcg
{
    /// <summary>
    /// 
    /// </summary>
    public class M3PcgFileReader : MPcgFileReader
    {
            ...
            : base(currentPcgMemory, content)
        {
            ...
            currentPcgMemory.Model = Models.Find(content[9] == 1 
                ? ModelsEOsVersion.EOsVersionM3_20 : ModelsEOsVersion.EOsVersionM3_1X);
            if (content[9] == 1)
            {
                currentPcgMemory.PcgChecksumType = PcgMemoryChecksumType.M3;
            }
        }
    }
}
