...
namespace Domain.ZeroSeries.Pcg
{
    ...
    public class ZeroSeriesSysExMemory : MntxSysExMemory
    {
        ...
        public ZeroSeriesSysExMemory(string fileName,
            ...
            : base(fileName, Models.EModelType.ZeroSeries, contentType, sysExStartOffset, sysExEndOffset,
                patchNamesCopyNeeded)
        {
        ...
        private void DuplicatePatchNames(int source, int destination, bool copyPrograms)
        {
            ...
            for (var patchIndex = 0; patchIndex < 100; patchIndex++)
            {
                ...
                Util.CopyBytes(this, source + patchIndex * (copyPrograms ? 172 : 128), destination + patchIndex * 10,
                    10);
            }
        }
    }
