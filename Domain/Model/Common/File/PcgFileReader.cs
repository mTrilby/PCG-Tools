...
namespace Domain.Model.Common.File
{
    ...
    public abstract class PcgFileReader : PatchesFileReader
    {
        ...
        private void ReadIni3Chunk(int chunkSize)
        {
            ...
            {
                CurrentPcgMemory.PcgChecksumType = PcgMemoryChecksumType.Kronos1516;
                CurrentPcgMemory.Model = Models.Find(ModelsEOsVersion.EOsVersionKronos15_16);
            }
...
// ReSharper restore RedundantStringFormatCall
            ...
            programBank.BankSynthesisType = programBank.DefaultModeledProgramBankSynthesisType;
