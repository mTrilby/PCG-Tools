...
namespace Domain.Model.Common.Synth.PatchCombis
{
    ...
    public abstract class Combi : Patch<Combi>, ICombi
    {
        ...
        ///
        /// </summary>
        public ITimbres Timbres { get; protected set; }
        ...
        public bool IsCompleteInPcg
        {
            get
            {
                return Timbres.TimbresCollection.All(timbre => (timbre.UsedProgramBank != null) &&
                                                               ...
                                                               ((timbre.UsedProgramBank.Type == BankTypeEType.Gm) ||
        ...
        public override void ChangeReferences(IPatch newPatch)
        {
            ...
            foreach (var setListSlot in
                ...
                where (setListSlot.SelectedPatchType == PatchType.Combi) &&
        ...
        public void ChangeVolume(ChangeVolumeParameters.ChangeVolumeParameters parameters, int minimumVolume, int maximumVolume)
        {
            foreach (var timbre in this.Timbres.TimbresCollection)
            {
