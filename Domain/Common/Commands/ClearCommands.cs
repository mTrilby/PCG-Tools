...
namespace PcgTools.ViewModels.Commands.PcgCommands
{
    ...
    public class ClearCommands
    {
            ...
            out bool clearUsedPatches)
        {
            ...
            switch ((ClearPatchesAlgorithm)SettingsDefault.UI_ClearPatches)
            {
            ...
            ref bool clearUsedPatches)
        {
            ...
            var result = _pcgViewModel.ShowMessageBox(
                Strings.ClearWarning, Strings.PcgTools, WindowUtil.EMessageBoxButton.YesNoCancel,
                WindowUtil.EMessageBoxImage.Warning, WindowUtil.EMessageBoxResult.Cancel);
        ...
        /// <param name="selectedPatches"></param>
        /// <returns>True if at least one patch cleared</returns>
        public bool ClearDuplicatesPatches(IPcgViewModel pcgViewModel, List<IPatch> selectedPatches)
        {
