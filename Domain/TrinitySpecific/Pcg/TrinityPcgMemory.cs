...
namespace Domain.TrinitySpecific.Pcg
{
    ...
    public class TrinityPcgMemory : PcgMemory
    {
            ...
            : base(fileName, modelType)
        {
            ...
            Model = Models.Find(Models.EOsVersion
                .EOsVersionTrinityV2); // Will be replaced later by V3 if a Moss bank is found.
        }
        ...
        /// <summary>
        ///     Used for master file check; depending on installation of memory extension deciding if a modeled bank has 64
        ///     programs and
        ...
        /// <returns></returns>
        private static int IsNeededProgramBankPresent(IBank bank1, int numberOfModeledBanks,
            ref int numberOfSampledProgramBanks)
        {
