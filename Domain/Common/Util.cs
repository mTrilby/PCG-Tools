...
namespace Domain.Common
{
    ...
    {
        private static readonly char[] CTerminators = { ' ', '\0', '\t', '\n' };
 ...
 */
        ...
        /// <param name="size"></param>
        public static void CopyBytes(PcgMemory pcgMemory, int sourceOffset, byte[] destination, int destinationOffset,
            int size)
        {
            Debug.Assert(pcgMemory != null);
...
// ReSharper restore UnusedMember.Global
        ...
        private static bool PrintRange(bool firstPrint, StringBuilder builder, IPatch patch, ref IPatch rangePatchStart,
            ref IPatch rangePatchEnd, ref bool lastPrint, ref bool needToPrint, ref int prevPatchIndex,
            ref IBank prevPatchBank)
        {
