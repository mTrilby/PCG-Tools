...
namespace Domain.Model.KronosSpecific.Synth
{
    ...
    public class KronosProgram : KronosOasysProgram
    {
        ...
        {
            var otherProgram = otherPatch as IClipBoardProgramKronosOs1516;
        ...
        public override IWaveSequence GetUsedWaveSequence(int osc, int zone)
        {
            ...
            if (GetZoneMsType(osc, zone) == EMode.WaveSequence)
            {
                ...
                {
                    case ModelsEOsVersion.EOsVersionKronos10_11: // FALL THROUGH
                    ...
                    case ModelsEOsVersion.EOsVersionKronos2x: // FALL THROUGH
