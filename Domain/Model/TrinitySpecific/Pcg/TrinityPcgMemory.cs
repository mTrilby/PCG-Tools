...
namespace Domain.Model.TrinitySpecific.Pcg
{
    ...
    public class TrinityPcgMemory : PcgMemory
    {
        ...
        public TrinityPcgMemory(string fileName, ModelsEModelType modelType)
            : base(fileName, modelType)
        {
            ...
            Model = Models.Find(ModelsEOsVersion.EOsVersionTrinityV2); // Will be replaced later by V3 if a Moss bank is found.
        }
