    ...
    public partial class ProgramReferenceChangerWindow // : Window
    {
        ...
        private void FromFileButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                try
                {
                    TextBoxRules.Text = File.ReadAllText(dialog.FileName);
                }
        ...
        private void DoWork_ChangeReferences(object sender, DoWorkEventArgs e)
        {
            ...
            Dispatcher.BeginInvoke(new Action(() => { ProgressBarRules.Maximum = 100; }));
        ...
        {
            Dispatcher.BeginInvoke(new Action(() => { ProgressBarRules.Value = args.ProgressPercentage; }));
        }
