...
namespace Domain.ClipBoard
{
    ...
    /// 
    /// </summary>
    public class ClipBoardCombi : ClipBoardPatch, IClipBoardCombi, IClipBoardCombiKronosOs1516
    {
        /// <summary>
        ...
        public ClipBoardCombi(IPatch combi): base(combi.Root.Content, combi.ByteOffset, combi.ByteLength)
        {
            ...
            // CBK2 content.
            if ((memory != null) && (memory.Model.OsVersion == ModelsEOsVersion.EOsVersionKronos15_16))
            {
