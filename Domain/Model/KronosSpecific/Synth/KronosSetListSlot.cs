...
namespace Domain.Model.KronosSpecific.Synth
{
    ...
    public class KronosSetListSlot : SetListSlot
    {
        ...
        public override void SetParameters()
        {
            ...
            if ((PcgRoot.Model.OsVersion != ModelsEOsVersion.EOsVersionKronos10_11) &&
                (PcgRoot.Model.OsVersion != ModelsEOsVersion.EOsVersionKronos15_16) &&
                (PcgRoot.Model.OsVersion != ModelsEOsVersion.EOsVersionKronos2x))
            {
        ...
        ///
        /// </summary>
        public override SetListSlotTextSize SelectedTextSize
        {
            get
            {
                return (SetListSlotTextSize)((BitsUtil.GetBits(PcgRoot.Content, ByteOffset + 29, 4, 4) << 2) + // MSB 1 bits
        ...
        protected override IBank UsedProgramBank => PcgRoot.ProgramBanks.GetBankWithPcgId(Util.GetBits(PcgRoot.Content,
            (PcgRoot.Model.OsVersion == ModelsEOsVersion.EOsVersionKronos15_16) ? Stl2BankOffset : DefaultBankOffset, 4, 0));
        ...
        private void SetUsedCombi(IPatch value)
        {
            ...
            if (PcgRoot.Model.OsVersion == ModelsEOsVersion.EOsVersionKronos15_16)
            {
        ...
        {
            if (bank.Type == BankTypeEType.UserExtended)
            {
        ...
        private IPatch GetUsedProgram
        {
            get
            {
                ...
                if (!((IBank) (program.Parent)).IsWritable && ((ProgramBank) (program.Parent)).Type != BankTypeEType.Gm)
                {
                    // Try to find it in the master file.
                    var masterPcgMemory = MasterFiles.MasterFiles.Instances.FindMasterPcg(Root.Model);
                    if ((masterPcgMemory != null) && (masterPcgMemory.FileName != Root.FileName))
        ...
        {
            var otherSetListSlot = otherPatch as IClipboardSetListSlotKronosOs1516;
            Debug.Assert(otherSetListSlot != null);
