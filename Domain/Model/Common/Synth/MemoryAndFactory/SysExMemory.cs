...
namespace Domain.Model.Common.Synth.MemoryAndFactory
{
    ...
    public abstract class SysExMemory : PcgMemory, ISysExMemory
    {
        ...
        protected SysExMemory(string fileName, ModelsEModelType modelType,
        ...
        {
            var models = new List<ModelsEModelType>
            {
                ModelsEModelType.M1,
                ModelsEModelType.M3R,
                ModelsEModelType.MicroKorgXl,
                ModelsEModelType.MicroKorgXlPlus,
                ModelsEModelType.Ms2000,
                ModelsEModelType.TSeries,
                ModelsEModelType.XSeries,
                ModelsEModelType.Z1,
                ModelsEModelType.ZeroSeries,
                ModelsEModelType.Zero3Rw
            };
