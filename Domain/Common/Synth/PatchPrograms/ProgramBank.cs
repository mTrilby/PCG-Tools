...
namespace PcgTools.Model.Common.Synth.PatchPrograms
{
    ...
    public abstract class ProgramBank : Bank<Program>, IProgramBank
    {
        ...
        protected ProgramBank(IBanks programBanks, BankType.EType type, string id, int pcgId,
        ...
        private string Description { [UsedImplicitly] get; }


        /// <summary>
        /// </summary>
        public SynthesisType BankSynthesisType { get; set; }
