...
namespace PcgTools.MasterFiles
{
    ...
    public class MasterFiles : ObservableCollectionEx<MasterFile>
    {
        ...
        public void Set(IMainViewModel mainViewModel)
        {
            ...
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionKronos3x), SettingsDefault.MasterFile_KronosOS3x));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionKronos2x), SettingsDefault.MasterFile_KronosOS2x));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionKronos15_16), SettingsDefault.MasterFile_KronosOS15_16));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionKronos10_11), SettingsDefault.MasterFile_KronosOS10_11));
            ...
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionMicroStation), SettingsDefault.MasterFile_MicroStation));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionTritonExtreme), SettingsDefault.MasterFile_TritonExtreme));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionTritonTrClassicStudioRack), SettingsDefault.MasterFile_TritonTrClassicStudioRack));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionTritonLe), SettingsDefault.MasterFile_TritonLe));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionTritonKarma), SettingsDefault.MasterFile_TritonKarma));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionTrinityV2), SettingsDefault.MasterFile_TrinityV2));
            Add(new MasterFile(Models.Find(Models.EOsVersion.EOsVersionTrinityV3), SettingsDefault.MasterFile_TrinityV3));
