...
namespace Domain.KronosSpecific.Synth
{
    ...
    public class KronosProgramBank : KronosOasysProgramBank
    {
        ...
        /// <summary>
        ///     Kronos only; in this chunk there are 66 parameters of 128 programs in order: (prg0, par0), (prg1, par0) to (prg126,
        ///     par 65), (prg127, par65)
        /// </summary>
        ...
        public int GetParameterOffsetInPbk2(int programIndex, int parameterIndex)
        {
            ...
            {
                offset += 32 * 2 * CountPatches + CountPatches +
                          programIndex; // two times 32 parameters + par 64 space + par 65 offset
            }
