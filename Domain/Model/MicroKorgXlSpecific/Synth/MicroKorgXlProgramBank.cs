...
namespace Domain.Model.MicroKorgXlSpecific.Synth
{
    ...
    public class MicroKorgXlProgramBank : ProgramBank
    {
        ...
        public MicroKorgXlProgramBank(IBanks programBanks, BankTypeEType type, string id, int pcgId,
        ...
        /// 
        /// </summary>
        public override ProgramBankSynthesisType DefaultSampledSynthesisType => ProgramBankSynthesisType.Mmt;
    }
}
