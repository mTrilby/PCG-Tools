    ...
    public class KronosTimbre : KronosOasysTimbre
    {
        ...
        public override IProgramBank UsedProgramBank
        {
            ...
            protected set
            {
                ...
                ((Combi)(Parent.Parent)).PcgRoot.Content[TimbresOffset + 1] =
                    ...
                    (value.Type == BankTypeEType.UserExtended) ?
        ...
        public override IProgram UsedProgram
        {
            ...
            set
            {
                ...
                Combi.PcgRoot.Content[TimbresOffset] = ((PcgRoot.Model.OsVersion == ModelsEOsVersion.EOsVersionKronos15_16) && 
                    (((IProgramBank)(value.Parent)).Type == BankTypeEType.UserExtended)) ? 
