...
namespace Domain.Model.TSeries.Pcg
{
    /// <summary>
    /// 
    /// </summary>
// ReSharper disable once InconsistentNaming
    public class TSeriesSysExMemory : MntxSysExMemory
    {
        ...
        public TSeriesSysExMemory(string fileName,
            ...
            : base(fileName, ModelsEModelType.TSeries, contentType, sysExStartOffset, sysExEndOffset, false)
        {
            ...
            Model = Models.Find(ModelsEOsVersion.EOsVersionTSeries);
        }
