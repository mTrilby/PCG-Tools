    ...
    public class KronosProgramBanks : KronosOasysProgramBanks
    {
        ...
        protected override void CreateBanks()
        {
            ...
            Add(new KronosProgramBank(
                ...
                "Initialized HD-1 Programs")); // 12 ; if changed -> change KronosTimbre
...
#pragma warning disable 1570
        ...
        ///         <A..H>
        ///             .
        ///             The PCG file that is created, adds the banks after the first two (so the bank IDS are 0, 1, 0x30, 0x30 + 1,
        ///             ... 0x30 + 63, 2, 3, ...
