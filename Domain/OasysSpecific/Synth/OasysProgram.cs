        ...
        public override IParameter GetParam(ParameterNames.ProgramParameterName name)
        {
            ...
            switch (name)
            {
                ...
                case ParameterNames.ProgramParameterName.Category:
                    parameter = IntParameter.Instance.Set(PcgRoot, PcgRoot.Content, ByteOffset + 2556, 4, 0, false,
                        this);
                    break;

                case ParameterNames.ProgramParameterName.SubCategory:
                    parameter = IntParameter.Instance.Set(PcgRoot, PcgRoot.Content, ByteOffset + 2556, 7, 5, false,
                        this);
                    break;
