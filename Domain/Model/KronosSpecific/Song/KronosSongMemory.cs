...
namespace Domain.Model.KronosSpecific.Song
{
    ...
    public class KronosSongMemory : SongMemory
    {
        ...
        /// 
        /// </summary>
        public ModelsEOsVersion InitOsVersion { private get; set; }
        ...
        public KronosSongMemory(string fileName)
            : base(fileName)
        {
            Model = Models.Find(ModelsEOsVersion.EOsVersionKronos2x); // Songs are always considered Kronos 2.x files
        }
