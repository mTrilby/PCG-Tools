...
namespace Domain.Model.Common.Synth.PatchSorting
{
    /// <summary>
    ...
    internal sealed class CategoricalComparer : Comparer<IPatch>
    {
        ...
        {
            var p1IsGm = (_p1 is Program) && (((IBank) (_p1).Parent).Type == BankTypeEType.Gm);
            var p2IsGm = (_p2 is Program) && (((IBank) (_p2).Parent).Type == BankTypeEType.Gm);
