...
namespace Domain.Model.Common.Synth.Meta
{
    ...
    public abstract class Patch<T> : ObservableObject, IPatch where T : INotifyPropertyChanged
    {
        ...
        public bool UseInList(
            ...
            ListGeneratorFilterOnFavorites useFavorites,
        ...
        /// <returns></returns>
        private bool CheckFavorite(ListGeneratorFilterOnFavorites useFavorites, bool usePatch)
        {
        ...
        /// <returns></returns>
        private static dynamic UseFavorite(ListGeneratorFilterOnFavorites useFavorites, 
            IParameter favoriteParameter)
        {
            return ((useFavorites == ListGeneratorFilterOnFavorites.All) ||
                    ((favoriteParameter != null) &&
                     (useFavorites == ListGeneratorFilterOnFavorites.No) &&
                     !favoriteParameter.Value) ||
                    ((favoriteParameter != null) &&
                     (useFavorites == ListGeneratorFilterOnFavorites.Yes) &&
                     favoriteParameter.Value));
        }
        ...
        public IPatch FirstDuplicate
        {
            get
            {
                ...
                return (from bank in ((IBanks)Parent.Parent).BankCollection 
                        where ((bank.Type != BankTypeEType.Gm) && bank.IsLoaded)
