...
namespace Domain.Model.ZeroSeries.Pcg
{
    /// <summary>
    /// 
    /// </summary>
    public class ZeroSeriesFileReader : SysExFileReader
    {
        ...
        private void ReadSyxMidContent(ISysExMemory memory)
        {
            ...
            switch (ContentType)
            {
                ...
                case PcgMemoryContentType.Global: // Fall through
                case PcgMemoryContentType.AllSequence: // Fall through
        ...
        protected virtual void ReadSingleProgram(int offset)
        {
            ...
            bank.ByteOffset = 0;
            bank.BankSynthesisType = ProgramBankSynthesisType.Ai2;
            bank.ByteLength = 172;
        ...
        private int ReadProgramData(int programBankIndex)
        {
            ...
            programBank.BankSynthesisType = ProgramBankSynthesisType.Ai;
