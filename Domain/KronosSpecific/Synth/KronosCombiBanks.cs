...
#pragma warning disable 1570
        ...
        /// To create virtual banks, name them like V
        /// <number>
        ///     <A..H>
            ...
            for (var parameter = 0; parameter < ParametersInCbk2Chunk; parameter++)
            {
                for (var timbre = 0; timbre < KronosTimbres.TimbresPerCombiConstant; timbre++)
                {
                    ...
                    var patchParameterOffset =
                        ((KronosCombiBank)patch.Parent).GetParameterOffsetInCbk2(patch.Index, timbre, parameter);
                    var otherPatchParameterOffset =
                        ((KronosCombiBank)otherPatch.Parent).GetParameterOffsetInCbk2(otherPatch.Index, timbre,
                            parameter);
