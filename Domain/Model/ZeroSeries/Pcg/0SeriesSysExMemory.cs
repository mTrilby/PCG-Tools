...
namespace Domain.Model.ZeroSeries.Pcg
{
    ...
    public class ZeroSeriesSysExMemory : MntxSysExMemory
    {
        ...
        public ZeroSeriesSysExMemory(string fileName,
            ...
            : base(fileName, ModelsEModelType.ZeroSeries, contentType, sysExStartOffset, sysExEndOffset, patchNamesCopyNeeded)
        {
            ...
            Model = Models.Find(ModelsEOsVersion.EOsVersionZeroSeries);
        }
