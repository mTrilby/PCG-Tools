...
namespace Domain.Model.Common.Synth.MemoryAndFactory
{
    ...
    public abstract class PcgMemory : Memory, IPcgMemory
    {
        ...
        /// 
        /// </summary>
        protected ModelsEModelType ModelType { get; private set; }


        /// <summary>
        /// 
        /// </summary>
        public PcgMemoryContentType ContentTypeType { private get; set; }
        ...
        protected PcgMemory(string fileName, ModelsEModelType modelType)
        {
        ...
        public void Fill()
        {
            ...
            PcgChecksumType = PcgMemoryChecksumType.None;
            Chunks = new Chunks();
        }
        ...
        /// 
        /// </summary>
        public PcgMemoryChecksumType PcgChecksumType { get; set; }
        ...
        public override void SaveFile(bool saveAs, bool saveToFile)
        {
            ...
            if (PcgChecksumType != PcgMemoryChecksumType.None)
            {
            ...
            catch (Exception)
            {
                ...
                // TODO: Original code handled this error gracefully!
                throw;
            }
        ...
        /// </summary>
        protected virtual void FixChecksumValues(PcgMemoryChecksumType checksumType)
        {
        }
        ...
        public virtual void SwapPatch(IPatch patch, IPatch otherPatch)
        {
            ...
            if (patch.Root.Model.OsVersion == ModelsEOsVersion.EOsVersionKronos15_16)
            {
        ...
        /// </summary>
        public bool CanContainOnlyOnePatch => ((ContentTypeType == PcgMemoryContentType.CurrentProgram) ||
                                               (ContentTypeType == PcgMemoryContentType.CurrentCombi) ||
                                               (ContentTypeType == PcgMemoryContentType.CurrentSequence) ||
                                               (ContentTypeType == PcgMemoryContentType.CurrentArpeggioPattern));
