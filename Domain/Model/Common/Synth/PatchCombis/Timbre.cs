    ...
    public abstract class Timbre : ObservableObject, ITimbre
    {
        ...
        public virtual IProgram UsedProgram
        {
            get
            {
                ...
                if (!UsedProgramBank.IsWritable && ((ProgramBank) (program.Bank)).Type != BankTypeEType.Gm)
                {
        ...
        private bool IsGmTimbre => ((ProgramBank) (UsedProgram.Parent)).Type == BankTypeEType.Gm;
        ...
        private string CategoryAsName
        {
            get
            {
                ...
                if ((UsedProgramBank == null) || (UsedProgramBank.Type == BankTypeEType.Gm))
                {
